  ...
  return (
    <section className="py-24 bg-ocean-gradient relative grain-overlay">
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-4xl font-display text-white mb-4 text-glow-gold">The Captain's Code</h2>
          <div className="w-20 h-0.5 bg-gradient-to-r from-transparent via-gold-500 to-transparent mx-auto mb-4" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {principles.map((item, index) => (
            <motion.div
              ...
              className="bg-navy-800/40 border border-navy-700 p-8 rounded-lg hover:border-gold-500/40 transition-all duration-300 group backdrop-blur-sm"
            >
              <div className="mb-4 p-3 bg-navy-950/60 w-fit rounded-lg shadow-lg group-hover:shadow-[0_0_20px_rgba(212,160,23,0.15)] transition-shadow">
                {item.icon}
              </div>
